...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		trace(Detector.getCurrentClass());
		...
		if (initialized && !transitioning && skippedIntro)
		{
			...
			if(pressedEnter)
			{
				...
				if (titleText.alpha == 1) {
					FlxTween.tween(titleText, {alpha: 0}, 1.8);
				}
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					createCoolText(['Powered By AshEngine']);
				case 3:
					addMoreText('pls no blam');
				case 4:
					addMoreText('lmao');
				case 5:
					deleteCoolText();
				...
				case 9:
					deleteCoolText();
				case 10:
					createCoolText(['Psych Engine']);
				case 11:
					addMoreText('By ShadowMario');
				case 12:
					addMoreText('shubs');
